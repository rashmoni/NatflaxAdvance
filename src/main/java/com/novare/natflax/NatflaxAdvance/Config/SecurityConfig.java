...
import com.novare.natflax.NatflaxAdvance.Security.CustomUserDetailService;
...
public class SecurityConfig {
    ...
    public static final String[] PUBLIC_URLS = {"/api/v1/auth/**", "/files/*", "/v3/api-docs", "/v2/api-docs",
